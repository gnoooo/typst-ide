...
pub fn init_db(path: &str) -> Result<Connection> {
    ...
    let _ = conn.execute_batch("ALTER TABLE bibliography ADD COLUMN project_path TEXT NOT NULL DEFAULT ''");
...
pub fn update_bibliography_entry(conn: &Connection, id: &str, title: &str, style: &str, path: &str, full: bool) -> Result<()> {
    conn.execute(
